...
from flask_bootstrap import Bootstrap5 #for using bootstrap in flask
from flask_sqlalchemy import SQLAlchemy #for database purpose
from sqlalchemy.orm import DeclarativeBase, Mapped, mapped_column #for mapping
