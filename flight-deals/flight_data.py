...
#Parses flight data received from the Amadeus API to identify the cheapest flight option among multiple entries.
    def find_cheapest_flight(data):
        """
        Args:
            data (dict): The JSON data containing flight information returned by the API.
        Returns:
            FlightData: represents the cheapest flight found,
            or where all fields are 'NA' if no valid flight data is available.
        """
